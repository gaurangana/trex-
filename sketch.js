...
function setup() {
  ...
  invisibleGround = createSprite(displayWidth/2, displayHeight-30, ground.width, 10);
...
function draw() {
  ...
  text("Hightest Score: "+ localStorage["highestScore"], windowWidth/2 + camera.position.x - 200, 100) ;
